    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="prose lg:prose-xl">
        ...
        <p>
          ...
          purposes only; this site shall not be responsible or liable for the
          accuracy, usefulness or availability of any information transmitted
          or made available via the site, and shall not be responsible or
        ...
        <p>
          ...
          special, or consequential damages for any reason whatsoever related
          to this website.
        </p>
      </div>
    </div>
